...
app.delete("/users/:id", async(req: Request, res: Response) => {
  try {
    ...
    if(result.rowsCount === 0) {
      ...
      return sendResponse(res, 200, true, "user delete successfully", result.rows);
    }
  } catch (error: any) {
    return sendResponse(res, 500, false, error.message);
  }
...
app.get("/todos", async(req: Request, res: Response) => {
  try {
    ...
    return sendResponse(res, 200, true, "todos fetch successfully", result.rows);
  } catch (error: any) {
    return sendResponse(res, 500, false, error.message);
  }
})
...
app.get("/todos/:id", async(req: Request, res: Response) => {
  try {
    ...
    if(result.rows.length === 0) {
      ...
      return sendResponse(res, 200, true, "single todo fetch successfully", result.rows[0]);
    }
  } catch (error: any) {
    return sendResponse(res, 500, false, error.message);
  }
...
app.put("/todos/:id", async(req: Request, res: Response) => {
  ...
  try {
    ...
    if(result.rows.length === 0) {
      ...
      return sendResponse(res, 200, true, "update todo successfully", result.rows[0]);
    }
  } catch (error: any) {
    return sendResponse(res, 500, false, error.message);
  }
